...
const WatchlistNotifications: React.FC<WatchlistNotificationsProps> = ({
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-80 bg-white text-black rounded-lg shadow-lg border border-black/10 z-50">
          <div className="p-4 border-b border-black/10">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-medium text-black">Watchlist Notifications</h3>
              {unreadCount > 0 && (
                <button
